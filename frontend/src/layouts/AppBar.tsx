    ...
    <>
      <Headroom style={{ zIndex: 999 }}>
        <div className="flex items-center justify-between">
          ...
          {width >= 768 && <Search query={query} setQuery={setQuery} wrapperClass="flex-1 max-w-[1054px] ml-5 mr-auto 4xl:ml-0" />}
      ...
      {width < 768 && (
        <ModalBase open={searchModalOpen} onClose={() => setSearchModalOpen(false)}>
          <div className="card max-w-[360px] w-full">
            ...
            <Search query={query} setQuery={setQuery} placeholder="What are you looking for?" />
          </div>
        </ModalBase>
      )}
      <NotificationsPanel
